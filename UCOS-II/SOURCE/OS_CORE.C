...
*                                            DUMMY FUNCTION
*
* Description: This function doesn't do anything.  It is called by OSTaskDel() and OSTaskIdle().
*
* Arguments  : none
*
* Returns    : none
...
void  OSInit (void)
{
    ...
    #if OS_STK_GROWTH == 1
    (void)OSTaskCreateExt(OSTaskIdle,
    ...
    #if OS_TASK_CREATE_EXT_EN
        #if OS_STK_GROWTH == 1
        (void)OSTaskCreateExt(OSTaskStat,
...
* Returns    : none
*
* Note(s)    : 1) OSDummy() is called after the critical section to ensure that interrupts will be
...
void  OSTaskIdle (void *pdata)
{
    ...
    for (;;) {
        ...
        OSIdleCtr++;
        OS_EXIT_CRITICAL();
        OSDummy();                               /* Ensure that interrupts will be enabled long enough */
    }
}
/*$PAGE*/
/*
